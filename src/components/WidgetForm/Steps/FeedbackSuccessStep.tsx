    ...
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[~304px]">
        ...
        <button
          ...
          className="py-2 px-6 mt-6 bg-zinc-200 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-400 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-brand-500"
          type="button"
        >
          Quero enviar outro
        </button>
